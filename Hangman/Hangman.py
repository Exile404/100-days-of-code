...
''']
word = [
    'abacus', 'abdomen', 'abide', 'ability', 'abnormal', 'aboard', 'abolish', 'abort', 'abound', 'above',
    'absence', 'absent', 'absolute', 'absorb', 'abstract', 'absurd', 'abundance', 'abuse', 'academy', 'accelerate',
    'accent', 'accept', 'access', 'accident', 'acclaim', 'accompany', 'accomplish', 'accord', 'account', 'accuracy',
    'accuse', 'achieve', 'acid', 'acknowledge', 'acoustic', 'acquire', 'acre', 'acrobat', 'across', 'act',
    'action', 'activate', 'active', 'actor', 'actress', 'actual', 'adapt', 'add', 'address', 'adequate',
    'adjust', 'administer', 'admire', 'admission', 'admit', 'adolescent', 'adopt', 'adult', 'advance', 'adventure',
    'advice', 'aerobics', 'aerosol', 'affair', 'affect', 'affirm', 'afford', 'afraid', 'after', 'against',
    'age', 'agency', 'agenda', 'agent', 'aggravate', 'aggregate', 'agree', 'ahead', 'aim', 'air',
    'aircraft', 'airport', 'aisle', 'alarm', 'album', 'alcohol', 'alert', 'alien', 'align', 'alive',
    'all', 'alley', 'allocate', 'allow', 'alloy', 'almost', 'alone', 'along', 'aloud', 'alphabet',
    'already', 'also', 'alter', 'always', 'amateur', 'amaze', 'ambassador', 'amber', 'ambition', 'ambulance',
    'amend', 'amid', 'among', 'amount', 'amuse', 'analyze', 'anchor', 'ancient', 'anger', 'angle',
    'angry', 'animal', 'ankle', 'announce', 'annual', 'answer', 'antenna', 'antique', 'anxiety', 'any',
    'apart', 'apology', 'apparent', 'appeal', 'appear', 'applaud', 'apple', 'appliance', 'approve', 'april',
    'aquarium', 'arcade', 'arch', 'area', 'arena', 'argue', 'arise', 'arm', 'armed', 'armor',
    'army', 'around', 'arrange', 'arrest', 'arrive', 'arrow', 'art', 'artefact', 'artist', 'ascend',
    'ash', 'aside', 'ask', 'asleep', 'aspect', 'assault', 'asset', 'assign', 'assist', 'assume',
    'assure', 'astonish', 'athlete', 'atom', 'attack', 'attend', 'attitude', 'attract', 'auction', 'audit',
    ...
    'bomb', 'bond', 'bone', 'bonus', 'book', 'boost', 'border', 'boring', 'borrow', 'boss',
    'bottom', 'bounce', 'box', 'boy', 'bracket', 'brain', 'brand', 'brave', 'bread', 'breeze',
    'brick', 'bridge', 'brief', 'bright', 'bring', 'brisk', 'broccoli', 'broken', 'bronze', 'broom',
    'brother', 'brown', 'brush', 'bubble', 'buddy', 'budget', 'buffalo', 'build', 'bulb', 'bulk',
    'bullet', 'bundle', 'bunker', 'burden', 'burger', 'burst', 'bus', 'business', 'busy', 'butter',
    'butterfly', 'button', 'buy', 'buzz', 'cabbage', 'cabin', 'cable', 'cactus', 'cage', 'cake',
    ...
    'category', 'cattle', 'caught', 'cause', 'caution', 'cave', 'ceiling', 'celery', 'celebrate', 'cell',
    'center', 'certain', 'chair', 'chalk', 'champion', 'change', 'chaos', 'chapter', 'charge', 'chase',
    'chat', 'cheap', 'cheese', 'chef', 'cherry', 'chest', 'chicken', 'chief', 'child', 'chimney',
    ...
    'couch', 'country', 'couple', 'course', 'cousin', 'cover', 'cow', 'crack', 'cradle', 'craft',
    ...
    'hard', 'harvest', 'hat', 'have', 'hawk', 'hazard', 'head', 'health', 'heart', 'heavy',
...
while True:
    ...
    if user_input not in choose_word:
        ...
        lives-=1
        print(stages[lives])
        print("Hehehe... Your guessed letter is not in word. Guess Right or DIE")

    else:
        for letter in range(len(choose_word)):
            if user_input == choose_word[letter]:
                guess_list[letter] = choose_word[letter]

        print(stages[lives])
        print("Shoot!!! You guessed Right. Damn boy.. Keep going")



if check:
    messagebox.showinfo("Congratulations", "DEM BOI.... YOU HAVE WON THE GAME")
else:
    messagebox.showinfo("Game Over", "HEHEHEHE... YOU ARE DEAD")